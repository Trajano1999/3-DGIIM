...
int producir_dato(int ih)
{
    ...
    mtx.lock();
    cout << "producido: " << ih * num_items / num_productores + cont_nprod[ih] << endl
         << flush;
    mtx.unlock();
...
void funcion_productores(MRef<MonitorProdCons> monitor, int ih)
{
...
void funcion_consumidores(MRef<MonitorProdCons> monitor)
{
...
{
    cout << "--------------------------------------------------------" << endl
         << "Problema de los productores-consumidores con monitor SU:" << endl
    ...
    MRef<MonitorProdCons> monitor = Create<MonitorProdCons>();
